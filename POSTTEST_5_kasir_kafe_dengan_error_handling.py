...
daf_menu = [
  ...
  {"nom": '4', "namaMenu": "Les larmes de Krixi", "hargaPer1": 15000, "jenisMenu": "minuman"},
  {"nom": '5', "namaMenu": "Le toast de Liliana", "hargaPer1": 22000, "jenisMenu": "makanan"},
  {"nom": '6', "namaMenu": "Banane frite védique", "hargaPer1": 20000, "jenisMenu": "makanan"},
  {"nom": '7', "namaMenu": "Poulet au beurre de soja", "hargaPer1": 35000, "jenisMenu": "makanan"},
  {"nom": '8', "namaMenu": "Biscuits de la soeur de Tanan", "hargaPer1": 10000, "jenisMenu": "makanan"},
]
def mataUang(nil):
...
try:
  ...
  print ("❗ ❗ ❗ ANDA SALAH MEMASUKKAN FORMAT INPUTAN ❗ ❗ ❗ ")
